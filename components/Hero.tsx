        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight mb-6">
              ...
              <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent"> Premium Web Design</span>
            </h1>
            <p className="text-xl text-gray-600 mb-8 max-w-2xl">
              We create fast, SEO-optimized websites that convert visitors into customers. 
              From concept to launch, we deliver exceptional digital experiences that drive growth.
            </p>
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-4 -right-4 w-full h-full bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl -z-10"></div>
          </div>
        </div>
      </div>
